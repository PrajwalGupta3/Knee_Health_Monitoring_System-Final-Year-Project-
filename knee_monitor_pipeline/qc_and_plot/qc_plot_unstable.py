...
plots_dir = Path("knee_monitor_pipeline/data/plots/unstable_qc")
plots_dir.mkdir(parents=True, exist_ok=True)

# (Load data is unchanged)
try:
    # This script reads the NEW CSV you created with the 10Hz data
    mpu_df = pd.read_csv(data_dir / "mpu_readings_unstable.csv")
    bmp_df = pd.read_csv(data_dir / "bmp_readings_unstable.csv")
...
baseline_path = data_dir / "final_csv" / "target_unstable_qc.csv"
