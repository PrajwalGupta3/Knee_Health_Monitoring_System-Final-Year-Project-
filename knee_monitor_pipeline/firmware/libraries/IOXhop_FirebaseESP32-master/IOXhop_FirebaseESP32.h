...
class FirebaseESP32 {
	public:
		...
		void setFloat(String path, float value, int point = 6) ;
		void setString(String path, String value) ;
		void setBool(String path, bool value) ;
		void set(String path, int value) ;
		void set(String path, float value, int point = 6) ;
